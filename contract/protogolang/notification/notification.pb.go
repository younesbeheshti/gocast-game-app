...
const file_contract_protobuf_notification_notification_proto_rawDesc = "" +
	"\n" +
	"1contract/protobuf/notification/notification.proto\x12\fnotification\"<\n" +
	"\fNotification\x12\x12\n" +
	"\x04type\x18\x01 \x01(\tR\x04type\x12\x18\n" +
	"\apayload\x18\x02 \x01(\tR\apayloadB#Z!contract/protogolang/notificationb\x06proto3"

var (
	file_contract_protobuf_notification_notification_proto_rawDescOnce sync.Once
	file_contract_protobuf_notification_notification_proto_rawDescData []byte
)
...
func file_contract_protobuf_notification_notification_proto_rawDescGZIP() []byte {
	file_contract_protobuf_notification_notification_proto_rawDescOnce.Do(func() {
		file_contract_protobuf_notification_notification_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_contract_protobuf_notification_notification_proto_rawDesc), len(file_contract_protobuf_notification_notification_proto_rawDesc)))
	})
...
func file_contract_protobuf_notification_notification_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_contract_protobuf_notification_notification_proto_rawDesc), len(file_contract_protobuf_notification_notification_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
